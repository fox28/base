package com.example.day09_04.utils;
...
//    }
    ...
    public OkUtils<T> downloadFile(File file) {
        mDownloadFile=file;
        mDownloadFileCallback =new DownloadFileCallback(null,false,file);
        return this;
    }

    DownloadFileCallback mDownloadFileCallback;
    public OkUtils<T> downloadFile(Context context, File file, boolean showProgress) {
        mDownloadFile=file;
        mDownloadFileCallback =new DownloadFileCallback(context,showProgress,file);
        return this;
    }
...
//        Log.e("main","url="+mUrl);
    ...
    class DownloadFileCallback implements Callback {
        ...
        public DownloadFileCallback(Context context, boolean showProgress, File file) {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            try {
                if (showProgress) {
                    downloadFile(context,response,file,true);
                } else {
     ...
     * @throws Exception
     */
    public void downloadFile(Context context, Response response, File file, boolean showProgress) throws Exception {
        FileOutputStream out = new FileOutputStream(file);
